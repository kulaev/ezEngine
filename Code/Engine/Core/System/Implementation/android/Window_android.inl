...
ezResult ezWindow::Initialize()
{
  ...
  // Checking and adjustments to creation desc.
  {
    ...
    {
      ezLog::Warning("Only FullscreenFixedResolution is supported on Android. Falling back to "
                     "ezWindowMode::FullscreenFixedResolution.");
  ...
  EZ_ASSERT_RELEASE(s_androidWindow == nullptr, "Currently, there is only a single UWP window supported!");
